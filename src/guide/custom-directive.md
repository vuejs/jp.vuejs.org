...
- **params**: params 属性を含んでいるオブジェクト。[以下で説明します](#21ffce5b8a6cc8cc6a41448dd69623c9)
...
いくつかのビルトインディレクティブに関する優先度は [API](/api/#0337f63b7e7f11c24da33c780bfa635a) で確認できます。さらに フロー制御するディレクティブ `v-if` と `v-for` は、コンパイル処理の中で常に最も高い優先度を持ちます。
