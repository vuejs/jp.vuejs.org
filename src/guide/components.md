...
"prop" は、コンポーネントデータ上のフィールドであり、そのコンポーネントデータは親コンポーネントから伝えられることを想定しています。子コンポーネントは、[`props` オプション](/api/#50fe03ab7bf37089a7e88da9b31ffb3b)を利用して受信することを期待するために、明示的に宣言する必要があります:
