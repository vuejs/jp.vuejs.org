...
`$nextTick()` は Promise を返却するため、あらたな [ES7 async/await](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Statements/async_function) 構文を用いて、同じことができます:
