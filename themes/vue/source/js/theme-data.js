var themeData = [
  {
    ...
    description: `[Creative Tim](https://creative-tim.com?affiliate_id=116187) のパートナーによって作られた以下の例を見ると、実世界のアプリケーションがどのように構築されるのか、その背後にある技術スタック、ここまで学んだ主要なコンセプトが実世界のアプリケーションにどう適用されるのか、を知ることができます。`,
